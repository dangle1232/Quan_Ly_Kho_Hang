    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get() == "":
                ...
                row= cur.fetchone()
                if row !=None:
                    messagebox.showerror("Error ","This Employee ID already assigned, try diffrient")
                else:
        ...
        try:
            if self.var_emp_id.get() == "":
                ...
                if row == None:
                    ...
                    answer = messagebox.askyesno("Confirmation", "Do you want to delete this employee?", parent=self.root)
                    if answer:
