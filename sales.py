...
class salesClass:
    def __init__(self, root):
        ...
        lbl_title = Label(self.root, text="View Customer Bills", font=("goudy old style", 30), bg="#184a45", fg="white",
                          bd=3, relief=RIDGE).pack(side=TOP, fill=X)
        lbl_invoice = Label(self.root, text="Invoice No.", font=("times new roman", 15), bg="white").place(x=50, y=100)
        lbl_invoice = Entry(self.root, textvariable=self.var_invoice, font=("times new roman", 15,), bg="lightyellow").place(
            x=160, y=100, width=180, height=28)
        ...
        btn_clear = Button(self.root, text="Clear", command=self.clear, font=("times new roman", 15, "bold"),
                           bg="lightgray", fg="white", cursor="hand2").place(x=490, y=100, width=120, height=28)
        ...
        lbl_title2 = Label(bill_Frame, text="Customer Bills Area", font=("goudy old style", 20), bg="orange").pack(
            side=TOP, fill=X)
        ...
        # Images
        # left menu
        self.bill_photo = Image.open("images/sale.png")
        self.bill_photo = self.bill_photo.resize((350, 300), Image.LANCZOS)
